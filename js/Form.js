...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    date.addEventListener('input', function() {
       ...
       try {
          (new EmployeePayrollData()).start_date = new Date(Date.parse(startDate));
...
const setEmployeePayrollData = (employeePayrollData) => {
    ...
    try {
        empPayrollData.start_date = new Date(Date.parse(employeePayrollObj._start_date));
    } catch(e) {
        setTextValue('.date-error',e);
        throw e;
    }
 ...
 const createAndUpdateStorage = () => {
   // localStorage.clear();
    ...
    if(employeePayrollList) {
        let empPayrollData = empPayrollList.
